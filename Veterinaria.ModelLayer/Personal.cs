...
namespace Veterinaria.ModelLayer
{
    ...
    public class Personal : Model<Personal>
    {
        ...
        /// <summary>
        /// Verifica si el personal tiene un rol espec�fico
        /// </summary>
        ...
        /// <summary>
        /// Método alias para ValidarCredenciales - para compatibilidad con AuthController
        /// </summary>
